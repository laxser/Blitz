...
/**
 * 
 *@author laxser  Date 2012-3-23 下午4:55:17
@contact [duqifan@gmail.com]
@PipeInterceptor.java
        ...
        if (pipe != null && pipe.getInvocation() == inv) {
            ...
            try {
                for (Window window : pipe.getWindows()) {
                    if (window.get(BlitzConstants.PIPE_WINDOW_IN) != Boolean.TRUE) {
                        synchronized (window) {
                            while (window.get(BlitzConstants.PIPE_WINDOW_IN) != Boolean.TRUE) {
