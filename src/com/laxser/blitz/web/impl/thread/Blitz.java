...
/**
 * 
 * @author laxser  Date 2012-3-28 上午9:57:01
@contact [duqifan@gmail.com]
@Blitz.java

 * 
 */
public class Blitz implements EngineChain {

    protected static final Log logger = LogFactory.getLog(Blitz.class);
    ...
    public Blitz(List<Module> modules, MappingNode mappingTree, HttpServletRequest httpRequest,
    ...
    /**
     * 启动blitz逻辑，对请求进行匹配判断，如果匹配未能成功返回false； <br>
