 ...
 * @author laxser
 */
public interface BlitzConstants {
    ...
    /**
     * 用于配置在每个module的包的blitz.properties，如果这个属性值为true代表这个目录以及子目录不作为module
     */
    ...
    /**
     * 可配置在模块下的module的blitz.properties表示本模块的最大允许的拦截器
     */
    public static final String CONF_INTERCEPTED_ALLOW = "intercepted.allow";

    /**
     * 可配置在模块下的module的blitz.properties表示本模块的不能允许的拦截器
     */
    public static final String CONF_INTERCEPTED_DENY = "intercepted.deny";

    /**
     *用于在每个module的包的blitz.properties中中，定义module.path时，
    ...
    public static final String PIPE_WINDOW_IN = "$$paoding-blitz-portal.window.in";

    public static final String WINDOW_ATTR = "$$paoding-blitz-portal.window";
